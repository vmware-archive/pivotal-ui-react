...
describe('Tabs', function() {
  var Tab;
  beforeEach(function() {
    Tab = require('../../../components/tabs/tabs').Tab;
  });

  describe('SimpleTabs', function() {
    beforeEach(function() {
      var SimpleTabs = require('../../../components/tabs/tabs').SimpleTabs;
      React.render(
        (
  ...
  describe('SimpleAltTabs', function() {
    beforeEach(function() {
      var SimpleAltTabs = require('../../../components/tabs/tabs').SimpleAltTabs;
