...
describe('DraggableList', function() {
  ...
  beforeEach(function() {
    DraggableList = require('../../../components/draggable-list/draggable-list').DraggableList;
    DraggableListItem = require('../../../components/draggable-list/draggable-list').DraggableListItem;
