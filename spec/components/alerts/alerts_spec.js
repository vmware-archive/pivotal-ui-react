...
describe('Alert', function() {
  var SuccessAlert;
  beforeEach(function() {
    SuccessAlert = require('../../../components/alerts/alerts').SuccessAlert;
  });
...
describe('SuccessAlert', function() {
  describe('when withIcon is set to true', function() {
    beforeEach(function() {
      var SuccessAlert = require('../../../components/alerts/alerts').SuccessAlert;
...
describe('InfoAlert', function() {
  describe('when withIcon is set to true', function() {
    beforeEach(function() {
      var InfoAlert = require('../../../components/alerts/alerts').InfoAlert;
...
describe('WarningAlert', function() {
   describe('when withIcon is set to true', function() {
     beforeEach(function() {
       var WarningAlert = require('../../../components/alerts/alerts').WarningAlert;
...
describe('ErrorAlert', function() {
   describe('when withIcon is set to true', function() {
     beforeEach(function() {
       var ErrorAlert = require('../../../components/alerts/alerts').ErrorAlert;
